...
function Search(){
    ...
    return(
        ...
        <div className="
        w-full
        flex flex-col justify-centre items-centre">
            <div className="
            w-full
            mb-4
            flex
            ...
            ">
                ...
                name="search" id="search" placeholder="Search Name" 
                className="
                rounded-md
                p-1
                w-full
    ...
    setSearch(false);
                    ...
                    return (
                        ...
                        flex
                        gap-1">
                            <input list = "searchList" type="text" name="search" id ="search" placeholder="Search Name" 
                            className="
                            rounded-md
                            p-1
                            w-full
